...
contains
    ...
    subroutine FEconf_entropy(FEconf,Econf)
        ...
        case ("brush_Mginter")
            call FEconf_brush_Mginter(FEconf,Econf) 
        case ("brush_neutralA")
            call FEconf_brush_neutralA(FEconf,Econf)
        case ("brush_mulnoVdW")
   ...
   ! computes conformational entropy in neutral state 
    ...
    subroutine FEconf_brush_neutralA(FEconf,Econf)
    ...
    end subroutine FEconf_brush_neutralA



    subroutine FEconf_brush_Mginter(FEconf,Econf)
    ...
    end subroutine FEconf_brush_Mginter
